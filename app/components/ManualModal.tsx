  ...
  const content = {
    GR: {
      ...
      sections: [
        ...
        {
          title: "02. Δημιουργία & Επεξεργασία Post(Create & Edit)",
          desc: "Πλήρης έλεγχος των αναμνήσεών σου.",
          items: [
            "Media:  Στο Edit, μπορείς να διαγράψεις παλιές (X) ή να προσθέσεις νέες (ένδειξη 'New').",
            "Food Wallet: Κατάγραψε το κόστος (€). Αυτό ενημερώνει το συνολικό σου budget στο προφίλ.",
            "Ratings: Σύρε τα αστέρια για να βαθμολογήσεις. Ο μέσος όρος υπολογίζεται αυτόματα.",
        ...
        },
        {
          ...
          items: [
            ...
            "Requests: Στείλε 'Add +' και περίμενε την αποδοχή.",
